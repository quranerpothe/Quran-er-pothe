...
module.exports.onStart = async ({ event, api }) => {
  ...
  try {
    let bg_img = await jimp.read("https://i.imgur.com/eSiaQok.jpeg");
    ...
    bg_img.resize(1030, 587)
      .composite(circleOne.resize(270, 270).circle(), 150, 165)
      .composite(circleTwo.resize(270, 270).circle(), 615, 160);
    const filePath = `./gf_${user1}_${user2}.png`;
    await bg_img.writeAsync(filePath);
    api.sendMessage(
      {
        body: `╔⏤⏤⏤╝❮❮𝐌𝐈𝐌-𝐁𝐎𝐓-𝟎𝟎𝟕❯❯╚⏤⏤⏤╗\n\nমন দেওয়া তো দূরের কথা 😏🥱কাওকে হসপট দেওয়ার আগেও দশবার ভাবি 🐸\n\n╔⏤⏤⏤╝❮❮𝐌𝐈𝐌-𝐁𝐎𝐓-𝟎𝟎𝟕❯❯╚⏤⏤⏤╗\n\n${mentions[user1] || 'User 1'} & ${mentions[user2] || 'User 2'}`,
