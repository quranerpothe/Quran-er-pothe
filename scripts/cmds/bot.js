...
module.exports = {
  ...
  onChat: async function ({ api, event, args }) {
    ...
    const messages = [
      ...
      `আন্টি-🙆-আপনার মেয়ে-👰‍♀-রাতে আমারে ভিদু কল দিতে বলে🫣-🥵🤤`,
  ...
  onReply: async function ({ api, event, args }) {
    ...
    try {
      const response = await axios.get(`${await baseApiUrl()}/sim?type=ask&ask=${encodeURIComponent(badol)}`);
      const replyMsg = response.data.data.msg;
